    ...
    <footer className="bg-foreground/5 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Federico Diaz Nemeth</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#education" className="text-foreground/70 hover:text-foreground transition-colors">
                  {t('nav.education')}
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-foreground/70">
              <li className="flex items-center">
                ...
                <a href="mailto:fdiaznemeth@gmail.com" className="hover:text-foreground transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-foreground/10 text-center text-foreground/60">
          <p>© {currentYear} Federico Diaz Nemeth. {t('footer.rights')}</p>
